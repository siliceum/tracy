...
#  define LockMark( varname )                                                                                                                                   \
      static constexpr tracy::SourceLocationData TracyConcat( __tracy_lock_location_, TracyLine ){ nullptr, TracyFunction, TracyFile, (uint32_t)TracyLine, 0 }; \
      varname.Mark( &TracyConcat( __tracy_lock_location_, TracyLine ) )
